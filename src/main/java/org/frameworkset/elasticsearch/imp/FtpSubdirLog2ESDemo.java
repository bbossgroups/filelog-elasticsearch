 ...
 * @version 1.0
 */
public class FtpSubdirLog2ESDemo {
	private static Logger logger = LoggerFactory.getLogger(FtpSubdirLog2ESDemo.class);
...
//			String repsonse = ElasticSearchHelper.getRestClientUtil().dropIndice("errorlog");
			...
			logger.info(repsonse);
			 repsonse = ElasticSearchHelper.getRestClientUtil().dropIndice("ftpsubdir-log");
			logger.info(repsonse);
		} catch (Exception e) {
		}
