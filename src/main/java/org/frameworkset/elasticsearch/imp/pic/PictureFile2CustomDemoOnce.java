package org.frameworkset.elasticsearch.imp.pic;
/**
...
import org.frameworkset.tran.input.other.CommonFileExtractor;
...
import org.frameworkset.tran.plugin.file.input.CommonFileInputConfig;
 ...
 * @version 1.0
 */
public class PictureFile2CustomDemoOnce {
	private static Logger logger = LoggerFactory.getLogger(PictureFile2CustomDemoOnce.class);
	public static void main(String[] args){
		...
		commonFileConfig.setSourcePath("D:\\workspace\\bbossesdemo\\filelog-elasticsearch\\picfiles")//指定图片目录
