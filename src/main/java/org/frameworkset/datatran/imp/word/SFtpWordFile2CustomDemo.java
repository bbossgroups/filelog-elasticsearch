 ...
 * @version 1.0
 */
public class SFtpWordFile2CustomDemo {
	private static Logger logger = LoggerFactory.getLogger(SFtpWordFile2CustomDemo.class);
	public static void main(String[] args){
        ...
        wordFileInputConfig.setScanNewFileInterval(30000L);
		//word文件采集配置
        ...
        FtpConfig ftpConfig = new FtpConfig().setFtpIP("101.13.6.127").setFtpPort(22)
                .setFtpUser("ecs").setFtpPassword("hnyd#433!")
