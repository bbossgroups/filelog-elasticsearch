package org.frameworkset.datatran.imp.oss;
/**
 ...
 * @version 1.0
 */
public class OSSWordFile2CustomDemo {
	private static Logger logger = LoggerFactory.getLogger(OSSWordFile2CustomDemo.class);
	public static void main(String[] args){
		...
		wordFileConfig.setSourcePath("C:\\data\\wordfilesoss")//指定word文件目录
