 ...
 * @version 1.0
 */
public class FileLog2CustomFileLivetimeDemo {
	private static Logger logger = LoggerFactory.getLogger(FileLog2CustomFileLivetimeDemo.class);
...
//				.setExcludeLines(new String[]{"\\[DEBUG\\]"}));//不采集debug日志
		...
		config.addConfig(new FileConfig("D:\\data\\filelivetime",//指定目录
